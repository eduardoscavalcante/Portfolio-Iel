...
export default function Hero() {
  ...
  return (
    ...
    <motion.section
      ...
      className="relative min-h-screen flex flex-col justify-between pt-16 pb-12 px-6 md:px-16 overflow-hidden bg-zinc-950 selection:bg-iel-red selection:text-white"
    ...
    >
      ...
      <motion.div
        ...
        className="w-full flex justify-between items-center border-b border-zinc-800/40 pb-6 text-[10px] font-mono tracking-[0.3em] text-zinc-400 uppercase relative z-20"
      ...
      {/* CENTRO: Logo Vertical Dominante */}

      <div className="relative w-full my-auto flex flex-col justify-center items-start py-8 relative z-10">
        ...
        <motion.div
          ...
          className="w-full relative z-10 flex flex-col items-start group"
        ...
        >
          ...
          <img
            ...
            className="h-[38vh] sm:h-[42vh] md:h-[48vh] w-auto block select-none object-contain transform transition-transform duration-700 hover:scale-[1.02]"
      ...
      <motion.div
        ...
        className="w-full flex flex-col md:flex-row justify-between items-start md:items-end border-t border-zinc-800/40 pt-8 gap-6 relative z-20"
